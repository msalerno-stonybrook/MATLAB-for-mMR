...
batFile = 'C:\Users\SUNY\Desktop\BME503_Final_Project\Study2\mMR\Input-Converted\Input-LM-00\Run-04-Input-LM-00-PSF-mMR.bat';
...
batFile = 'C:\Users\SUNY\Desktop\BME503_Final_Project\Study2\mMR\Input-Converted\Input-LM-00\Run-04-Input-LM-00-PSF-TP.bat';
startInfo = System.Diagnostics.ProcessStartInfo('cmd.exe', sprintf('/c "%s"', batFile));
% startInfo.WindowStyle = System.Diagnostics.ProcessWindowStyle.Hidden;  %// if you want it invisible
proc = System.Diagnostics.Process.Start(startInfo);
if isempty(proc)
