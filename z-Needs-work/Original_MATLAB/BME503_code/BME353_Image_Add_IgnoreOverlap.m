fid=fopen('C:\Users\SUNY\Desktop\BME503_Final_Project\Study1\mMR\Input-Converted\Input-LM-00\Coreg\TPumap_coreg2_mMRumap_crop.img');
fid1=fopen('C:\Users\SUNY\Desktop\BME503_Final_Project\Study1\mMR\Input-Converted\Input-LM-00\Coreg\mMR_Neck.img');

[data,count]=fread(fid,'float32');
[data1,count1]=fread(fid1,'float32');

fid2=fopen('C:\Users\SUNY\Desktop\BME503_Final_Project\Study1\mMR\Input-Converted\Input-LM-00\Coreg\1-TPu-umap_final.img', 'w');
...
batFile = 'C:\Users\SUNY\Desktop\BME503_Final_Project\Study1\mMR\Input-Converted\Input-LM-00\Run-04-Input-LM-00-PSF-TP.bat';
startInfo = System.Diagnostics.ProcessStartInfo('cmd.exe', sprintf('/c "%s"', batFile));
% startInfo.WindowStyle = System.Diagnostics.ProcessWindowStyle.Hidden;  %// if you want it invisible
proc = System.Diagnostics.Process.Start(startInfo);
if isempty(proc)
